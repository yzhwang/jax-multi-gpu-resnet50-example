...
def load(
  ...
  ds = tfds.load('imagenet2012:5.*.*', data_dir='/mnt/home/wangyzh/dataset/imagenet-tfrecord', split=tfds_split,
...
def _device_put_sharded(sharded_tree, devices):
  ...
  n = leaves[0].shape[0]
  sharded_tree = jax.device_put_sharded(
